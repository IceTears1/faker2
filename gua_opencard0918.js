...
guaopencard12="true"
————————————————
入口：[8.18-8.25 全民818 一“促”即发" (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7534564?activityId=02d54511202b4d1781088b66b9e07b9c&shareUuid=c0bcf5c57dcc4446aab0f0fe111f6497)]
============Quantumultx===============
[task_local]
...
!(async () => {
  ...
  $.shareUuid = '13f405fba22345148d0431b501d2f99a'
  $.activityId = '21h3i1h3h2u1h3g43gy4g3yu2u23u423'
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7534564?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
...
async function run(){
  try{
    ...
    if(!$.addSku && guaopencard_addSku == "true") await $.wait(1800)
    await getActorUuid()
    await $.wait(1000)
...
function shopactivityId(functionId) {
  return {
    ...
    headers: {
      ...
      'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7534564?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
      'Cookie': cookie
    }
  }
}
...
function accessLogWithAD() {
  return new Promise(resolve => {
    let pageurl = `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7534564?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
  return new Promise(resolve => {
    let get = {
      url:`https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/3770899?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
      headers: {
        "Cookie": cookie,
        "User-Agent": $.UA,
      }
...
function taskPostUrl(url, body) {
  return {
    ...
    headers: {
      ...
      "Referer": `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7534564?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
      "User-Agent": $.UA ,
    }
  }
}
